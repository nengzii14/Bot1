...
cl = LINETCR.LINE()
cl.login(token='EldPZrXX1YhEQJE0bqYb.JaaokEjc/UYA8Uay1IOywW.nJJbjs27FwuTGT0s7voohWYWkJHk62RzPKoT6VGiHYc=')
cl.loginResult()
...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + ", (home)สวัดดีลูกค้าใหม่นะครับดูรายละเอียดในโน๊ตก่อนได้เลยนะครับ\nมีอะไรไม่เข้าใจสอบถามได้นะครับ")
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
				sendMessage(op.param1, client.getContact(op.param2).displayName + ", ทำอะไรกันคิคิ\nอย่าคิดว่าไม่รู้")
